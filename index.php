            ...
            <div class="container">
                ...
                <section class="row">
                    ...
                    <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="bestselling__product-text">
                            <h3 class="bestselling__product-title">
                                <a href="#" class="bestselling__product-link">Thám Tử Đã Chết - Tập 1 - Tặng Kèm
                                    Bookmark Tròn</a>
                            </h3>
                        ...
                        <div class="row product__panel">
                            ...
                            <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                                <div class="product__panel-item-wrap">
                                    ...
                                    <h3 class="product__panel-heading">
                                        <a href="product.php" class="product__panel-link">My Hero Academia - Tập 27:
                                            One’s Justice</a>
                                    </h3>
                            ...
                            <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                                <div class="product__panel-item-wrap">
                                    ...
                                    <h3 class="product__panel-heading">
                                        <a href="#" class="product__panel-link">My Hero Academia - Tập 5: Todoroki
                ...
                <article class="row posts__list">
                    <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="posts__item-description">
                            ...
                            tâm, bài viết này dành cho bạn! Trong bài viết này mình sẽ chia sẻ đến bạn những mẹo, những
                            kinh nghiệm giúp bạn săn được nhiều mã giảm giá EduBook nhất có thể.....
                        </div>
                    </div>
                    ...
                    <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="posts__item-description">
                            Để các độc giả, phụ huynh, học sinh và các thầy cô giáo… không mua phải các loại sách tham
                            khảo giả, sách in lậu, mình sẽ hướng dẫn cách phân biệt sách thật, giả nhanh chóng và chính
                            xác. Nếu bạn chú ý quan sát một xíu là có thể phân biệt được sách giả
                            ngay. Với sách giả khi cầm trên tay sẽ có cảm giác mềm hơn, không cứng và chắc tay như sách
                            thật...
                        </div>
                    </div>
                    ...
                    <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="posts__item-description">
                            ...
                            EduBook cho phép bạn sử dụng cùng lúc 3 loại mã giảm giá mà mình đã kể trên trong cùng 1 đơn
                            hàng. Bao gồm: Mã FreeShip, Mã giảm giá của Shop, Và Ưu đãi từ đối tác
                            thanh toán,....
                        </div>
                    </div>
                    ...
                    <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="posts__item-description">
                            Mua hàng trên Edu Book nhưng sản phẩm bạn nhận được không giống hình, sản phẩm bị lỗi. Bạn
                            nghĩ mình bị lừa, bạn bối rối không biết làm thế nào và quyết định search google: “Phải làm
                            gì khi muốn hoàn trả hàng hoàn tiền trên Edu Book”. Bài viết này sẽ
            ...
            <div class="modal__body">
                ...
                <div class="sale-off">
                    <div class="sale-off__container">
                        ...
                        <a href="product.php" class="sale-off__link">
