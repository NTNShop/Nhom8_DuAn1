    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row user-list">
            ...
            <ul class="user_item">
                ...
                <li class="action"><a href="?khach-hang&btn_edit&ma_kh=<?= $item['ma_kh'] ?>"><i
                            class="fa-regular fa-pen-to-square"></i></a></li>
                <li class="action"><a href="?khach-hang&btn_delete&ma_kh=<?= $item['ma_kh'] ?>"><i
                            class="fa-regular fa-trash-can"></i></a></li>
            </ul>
            <?php } ?>
        </div>
        <div class="row">
            <a href="?khach-hang&btn_insert" class="btn"><i class="fa-solid fa-plus"></i></a>
        </div>
    </div>
</body>
